(function($) {
  ...
  $(document).on('click','#v-pills-link-tab',function(){
    $(this).addClass('active');
    $('#v-pills-link').addClass('active');
    $('#v-pills-details-tab').removeClass('active');
    $('#v-pills-details').removeClass('active');

});

$(document).on('click','#v-pills-details-tab',function(){
    $(this).addClass('active');
    $('#v-pills-details').addClass('active');
    $('#v-pills-link-tab').removeClass('active');
    $('#v-pills-link').removeClass('active');
...
$(document).on('click','.attribute',function(){
        ...
        $.ajax({
         ...
         success:function(data)
         {
          if ((data.errors)) {
            ...
            $('#attribute,#modal1,#modal2,#verify-modal,#adcreate,#editModal').modal('hide');
  ...
  $(document).on('click','#send',function(){
    $('#eml1').val($(this).data('email'));
            ...
            $(document).on("submit", "#emailreply2" , function(){
