...
<!-- User Dashboard -->
    ...
    <div class="breadcrumb-area">
        <h3 class="title text--white">@lang('CTA Contact Edit')</h3>
        <ul class="breadcrumb">
            <li>
                <a href="{{ route('user.dashboard') }}">@lang('Dashboard')</a>
            </li>
            <li>
                @lang('CTA Contact Edit')
            </li>
        </ul>
    </div>
</div>
        <div class="dashborad--content">
            <div class="dashboard--content-item">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <form id="userform" action="{{route('user.update-contact-overlay',$contact->id)}}" method="POST">
                @csrf
                ...
                <div class="profile--card">
                        ...
                        <div class="row gy-4">
                            <div class="col-sm-6 col-xxl-4">
                                ...
                                <input type="text" id="name" name="name" class="form-control form--control bg--section"
                                    value="{{ $contact->name }}" required="" placeholder="{{ __('Enter Contact Overlay Name') }}">
                            </div>
                            <div class="col-sm-6 col-xxl-4">
                                <label for="email" class="form-label">@lang('Email')</label>
                                <input  type="email" id="email" class="form-control form--control bg--section"
                                     name="email" value="{{ $data->email }}" required placeholder="@lang('Enter Your Email')">
                            </div>
                            <div class="col-sm-6 col-xxl-4">
                                ...
                                <input  type="text" id="subject" class="form-control form--control bg--section"
                                     name="subject" required value="{{ $data->subject }}" placeholder="Email Subject Here...">
                            </div>

                            <div class="col-sm-6 col-xxl-4">
                                <label for="form_label" class="form-label">@lang('Form Label')</label>
                                <input type="text" id="label" value="{{ $data->label }}" placeholder="@lang('Mail Send')" name="label" class="form-control form--control bg--section" >
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-text" ><i class="fa fa-question-circle" aria-hidden="true"></i> <span id="label_text"></span>{{ $data->label }}</h5>
                            </div>
                        </div>

                        <div class="card mt-3">
                            <div class="card-body">
                                <h5 class="card-title " id="form-title">{{ $data->label ? $data->label : __('Email Form') }}</h5>
