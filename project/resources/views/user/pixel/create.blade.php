...
<!-- User Dashboard -->
    ...
    <div class="breadcrumb-area">
        <h3 class="title text--white">@lang('Create Pixel')</h3>
        <ul class="breadcrumb">
            <li>
        ...
        <div class="dashborad--content">
            <div class="dashboard--content-item">
                ...
                <form id="userform" action="{{route('user.store-pixel')}}" method="POST">
                @csrf
                <div class="profile--card">
                        <div class="row gy-4">
                            <div class="col-sm-6 col-xxl-4">
                                <div class="form-group my-2">
                                    <label for="my-select">Pixel Provider</label>
                                    <select id="my-select" class="form-control" name="type">
                                        <option value="facebook">@lang('Facebook')</option>
                                        <option value="google">@lang('Google Tag Manager')</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xxl-4">
