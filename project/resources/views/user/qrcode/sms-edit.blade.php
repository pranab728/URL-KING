                    ...
                    <div class="card-body">
                       ...
                       <hr>
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link {{ $view->type=='sms' ? 'active':'' }}" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">@lang('SMS/Message')</button>
                          </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade {{ $view->type=="sms" ? 'show active':'' }}" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                <form action="{{ route('user.update-sms-qr',$qr->id) }}" method="POST">
                                    @csrf
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control form--control bg--section" name="phone" placeholder="e.g. +8801xxxxxxxxx" value="{{ $view->phone }}" required>
                                </div>
                                <div class="mt-3">
