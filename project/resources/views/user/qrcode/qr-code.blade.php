                    ...
                    <div class="card-body">
                       ...
                       <hr>
                        ...
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            @if ($view->type == 'text')
                            <button class="nav-link {{ $view->type=='text' ? 'active':'' }}" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">@lang('Text')</button>
                            @endif
                            @if ($view->type == 'sms')
                            <button class="nav-link {{ $view->type=='sms' ? 'active':'' }}" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">@lang('SMS')</button>
                            @endif

                            @if ($view->type == 'wifi')
                            <button class="nav-link {{ $view->type=='wifi' ? 'active':'' }}" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">@lang('Wifi')</button>
                            @endif

                            @if ($view->type == 'vcard')
                            <button class="nav-link {{ $view->type=='vcard' ? 'active':'' }}" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">@lang('Vcard')</button>
                            @endif
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <input type="hidden" name="name" id="text_name" value="{{ $qr->name }}">
                                ...
                                <textarea name="text" class="form-control" id="" cols="30" rows="5">{{ $view->text }}</textarea>
                                {{-- <button class="btn btn-primary mt-4" type="submit">@lang('Update QRcode')</button> --}}
                            </div>
                            @endif
                            ...
                            <div class="tab-pane fade show active" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control form--control bg--section" value="{{ $view->phone }}" name="phone" placeholder="e.g. +8801xxxxxxxxx" required>
                                    </div>
                                    <div class="mt-3">
                                        <label for="text" class="form-label ">@lang('Message')</label>
                                        <input type="text" class="form-control form--control bg--section" value="{{ $view->message }}" name="message" placeholder="e.g. your message here" required>
                                </div>
                            ...
                            <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form--control bg--section" value="{{ $view->ssid }}" name="ssid" placeholder="e.g. 123455324" required>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form--control bg--section" value="{{ $view->first_name }}" name="first_name" placeholder="e.g. jhon" required>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Last Name')</label>
                                    <input type="text" class="form-control form--control bg--section" value="{{ $view->last_name }}" name="last_name" placeholder="e.g. Doe" required>
                                </div>

                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Organization')</label>
                                    <input type="text" class="form-control form--control bg--section" name="organization" placeholder="e.g. Soft IT center" value="{{ $view->organization }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Phone')</label>
                                    <input type="text" class="form-control form--control bg--section" value="{{ $view->phone }}" name="phone" placeholder="e.g. +990123456" required>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Email')</label>
                                    <input value="{{ $view->email }}" type="text" class="form-control form--control bg--section" name="email" placeholder="e.g. myemail@mail.com" required>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Address')</label>
                                    <input type="text" value="{{ $view->address }}" class="form-control form--control bg--section" name="address" placeholder="e.g. your address" required>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label ">@lang('Website')</label>
                                    <input type="text" value="{{ $view->website }}" class="form-control form--control bg--section" name="website" placeholder="e.g. https://domain.com" required>
                                </div>
                                <button class="btn btn-primary mt-4" type="submit">@lang('Generate QRcode')</button>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary w-100" href="{{ asset('project/public/images/'.$view->image) }}" download="{{ $view->image }}">Download image</a>
                    </div>
                </div>
            </div>
