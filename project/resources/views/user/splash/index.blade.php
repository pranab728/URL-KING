...
<div class="breadcrumb-area">
    ...
    <div class="d-flex justify-content-between">
        <div class="one">
            <h3 class="title text--white">@lang('Custom Splash')</h3>
            <ul class="breadcrumb">
                <li>
        ...
        <div class="two">
            <a href="{{ route('user.create-splash') }}" class="btn btn-primary">@lang('Create a Custom Splash')</a>
        </div>
    </div>
                ...
                <div class="dashboard-card">
                    <div class="dashboard-card__header">
                        <div class="dashboard-card__header__icon">
                            <img src="{{ asset('assets/images/splash/'.$sp->avatar) }}" alt="">
                        </div>
                        <div class="dashboard-card__header__cont">
                            ...
                            <div class="dropdown btn-group mb-1">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" aria-labelledby="dropdown">
                                  <a  href="{{ route('user.edit-splash',$sp->id) }}"   class="dropdown-item link-status" >@lang("Edit")</a>

                                  <a  href="javascript:;" data-bs-toggle="modal" data-bs-target="#deleteModal" class="dropdown-item link-status dismiss" data-href="{{ route('user.delete-splash',$sp->id) }}">@lang("Delete")</a>
                                </div>
                              </div> 
                    ...
                    <div class="card-footer">
                        <p> <small>{{ $sp->created_at->diffForHumans() }}</small></p>
                    </div>
