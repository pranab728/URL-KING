      ...
      <form  action="{{route('admin.blog.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="tags" value="{{ $data->tags }}" name="tags" placeholder="{{ __('Tags') }}">
          </div>
          ...
          <div class="showbox d-none">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="meta_tag" value="{{ $data->meta_tag }}" name="meta_tag" placeholder="{{ __('Meta Tags') }}">
            </div>
