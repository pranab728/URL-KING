  ...
  <div class="col-lg-6">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="" action="{{route('admin.page.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="showbox d-none">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="meta_tag" name="meta_tag" value="{{$data->meta_keywords}}" placeholder="{{ __('Meta Tags') }}">
            </div>
