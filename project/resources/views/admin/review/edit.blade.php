...
<div class="card">
  ...
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{route('admin.rating.edit',$data->id)}}">{{ __('Edit Client') }}</a></li>
  </ol>
  </div>
</div>
...
<div class="col-lg-6">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <form action="{{route('admin.rating.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="wrapper-image-preview">
                <div class="box">
                    <div class="back-preview-image" style="background-image: url({{$data->photo ? asset('assets/images/client/'.$data->photo) : asset('assets/images/placeholder.jpg') }});"></div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name"  placeholder="{{ __('Enter Title') }}" value="{{ $data->name }}" required>
        </div>

        <div class="form-group">
            <label for="title">{{ __('Ratings') }}</label>
            <input type="text" class="form-control" id="rating" name="rating"  placeholder="{{ __('Give Ratings 1-5 digit') }}" value="{{ $data->rating }}" required>
        </div>
