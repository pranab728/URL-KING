                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" name="section[]" value="Link Management" {{ $data->sectionCheck('Link Management') ? 'checked' : '' }}  class="custom-control-input" id="manage_category">
                        <label class="custom-control-label" for="manage_category">{{__('Link Management')}}</label>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" name="section[]" value="Advertisement" {{ $data->sectionCheck('Advertisement') ? 'checked' : '' }}  class="custom-control-input" id="manage_product">
                        <label class="custom-control-label" for="manage_product">{{__('Advertisement')}}</label>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" name="section[]" value="Plan" {{ $data->sectionCheck('Plan') ? 'checked' : '' }} class="custom-control-input" id="author_level">
                        <label class="custom-control-label" for="author_level">{{__('Plan')}}</label>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-6">
