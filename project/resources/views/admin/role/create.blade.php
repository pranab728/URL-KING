        ...
        <form class="geniusform" action="{{route('admin.role.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Link Management" class="custom-control-input" id="manage_category">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Advertisement" class="custom-control-input" id="manage_order">
                  <label class="custom-control-label" for="manage_order">{{__('Advertisement')}}</label>
                  </div>
              </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Plan" class="custom-control-input" id="author_level">
