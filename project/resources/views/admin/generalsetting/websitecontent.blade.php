      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form  action="{{ route('admin.gs.update') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  <label for="inp-title">{{  __('Advertisement Time')  }}</label>
                  <input type="number" class="form-control" id="inp-title" name="ad_timeset"  placeholder="{{ __('Advertisement Timeset') }}" value="{{ $gs->ad_timeset }}" required>
               </div>
               <div class="form-group">
                  <label for="inp-title">{{  __('Withdraw charge')  }} <small>({{ __('In Percentage') }})</small> </label>
                  <input type="text" class="form-control" id="inp-title" name="withdraw_charge"  placeholder="{{ __('Withdrawl Charge') }}" value="{{ $gs->withdraw_charge }}" required>
               </div>
               <div class="form-group">
                  <label for="inp-title">{{  __('Withdraw Limit')  }} <small>({{ __('In USD') }})</small> </label>
                  <input type="text" class="form-control" id="inp-title" name="withdraw_limit"  placeholder="{{ __('Withdrawl Limit') }}" value="{{ $gs->withdraw_limit }}" required>
               </div>
               <div class="form-group">
                  <label for="inp-title">{{  __('Advertisement Reward')  }} <small>({{ __('Per Click In USD') }})</small> </label>
                  <input type="text" class="form-control" id="inp-title" name="ad_reward"  placeholder="{{ __('Advertisement Reward') }}" value="{{ $gs->ad_reward }}" required>
               </div>
